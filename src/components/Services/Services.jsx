...
<section className="section-hero-section text-center position-relative">
                ...
                <div className="container">
                    <div className="row align-items-center ">
                        ...
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Corporate Car Hire</h6>
...
>>>>>>> 9a489bc7feb133706a14f3ed8f304b73cb2a4ff5
                    ...
                    <div className="row align-items-center " >
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Wedding Cars</h6>
...
>>>>>>> 9a489bc7feb133706a14f3ed8f304b73cb2a4ff5
                    ...
                    <div className="row align-items-center  reverse" >
                        ...
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Event Transportation</h6>
...
>>>>>>> 9a489bc7feb133706a14f3ed8f304b73cb2a4ff5
                    ...
                    <div className="row align-items-center  reverse" >
                        ...
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Bus /Coach Transportation</h6>
...
>>>>>>> 9a489bc7feb133706a14f3ed8f304b73cb2a4ff5
                    ...
                    <div className="row align-items-center " >
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Surprise Rides</h6>
...
>>>>>>> 9a489bc7feb133706a14f3ed8f304b73cb2a4ff5
                    ...
                    <div className="row align-items-center  reverse" >
                        ...
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Yacht Rentals</h6>
...
>>>>>>> 9a489bc7feb133706a14f3ed8f304b73cb2a4ff5
                    ...
                    <div className="row align-items-center " >
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Airport Car Rental In Chennai</h6>
...
<<<<<<< HEAD
                    ...
                    <div className="col-md-6 col-12">
                        ...
                        <div className="col-md-6 col-12 text-content">
                            <h6 className="text-uppercase" >Employee Transportation</h6>
