        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/7series.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">BWM 7 Series</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/augusta.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Helicoptor Augusta</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/bell.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Helicoptor Bell</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/benz_26.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Mercedes Benz Bus</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/commuter.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Toyoto Commuter</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/gls450d.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Mercedes Benz GLS450D</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/hawker.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Private Jet Hawker</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/hycrosshybrid.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Toyota Hycross Hybrid</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/hycrosspetrol.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Toyota Hycross</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/leyland40.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Leyland Bus</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/leyland_34.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Leyland Bus</h5>
                            <p className="card-text">Customized On Request</p>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/tempo.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/urbania.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Urbania</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="car-rental-card custom-card h-100 border-0 shadow-sm">
                    <Link to="#">
                            <img src="images/carRentals/vclass.png" className="card-img-top" alt="Cadillac Limousine XTS"/>
                        </Link>
                        <div className="card-body custom-body text-center">
                            <h5 className="card-title">Mercedes Vclass</h5>
                            <p className="card-text">Customized On Request</p>
                            {/* <ul className="list-unstyled d-flex justify-content-center mb-3">
                                <li className="mx-2 feature-box"><i className="fa fa-user"></i> 4 seats</li>
                                <li className="mx-2 feature-box"><i className="fa fa-gas-pump"></i> Diesel</li>
