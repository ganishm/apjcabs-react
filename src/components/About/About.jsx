  ...
  return (
        ...
        <div className="container">
            <div className="row align-items-center">
                ...
                <div className="col-md-6 d-flex flex-column justify-content-center">
                    ...
                    <a href="../tariff/tariff.html" className="btn btn-primary mt-auto">Rent Now</a>
                </div>
    ...
    <div className="container">
        ...
        <div className="row justify-content-center">
            ...
            <div className="col-md-4 col-sm-6 mb-4">
                <div className="service-box">
                    <i className="fas fa-gem service-icon"></i>
                    <h4 className="service-title">Limousine and Chauffeur Hire</h4>
                    <p className="service-description">Vestibulum at ultrices elit. Maecenas faucibus vulputate vestibulum</p>
                </div>
            </div>
        </div>
    ...
    <div className="container">
        <div className="row align-items-center">
            <div className="col-lg-6">
                ...
                <form action="#" method="POST" className="form-box" id="bookingForm">
                    ...
                    <div className="form-group">
                        <input type="text" className="form-control" placeholder="Pickup Location" id="pickup-location" required />
                    </div>
                    <div className="form-group">
                        <input type="text" className="form-control" placeholder="Return Location" id="return-location" required />
                    </div>
                    <div className="form-group">
                        <input type="date" className="form-control" placeholder="Pick-Up Date" id="pick-up-date" required />
                    </div>
                    <div className="form-group">
                        <input type="date" className="form-control" placeholder="Return Date" id="return-date" required />
                    </div>
