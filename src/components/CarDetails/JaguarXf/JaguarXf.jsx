    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/jag_xf.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Jaguar <span style={{color: "#18B2D3"}}>XF</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>JAGUAR XF ( 4+1):</span><br/>
                4 Door luxury Car rental in Chennai.
                JAGUAR XF looks like it is meant for Royal eyecatching magnificent Car . Unique BRITISH Kid now taking it up to the rest of the world by glamorous look. APJ cabs offers JAGUAR XF Car Rental In Chennai and across India for those who have a affinity towards this great Luxury sedan.
                When we announced the arrival of JAGUAR XF to our existing fleet we had a stunning response from those Christain wedding segment . JAGUAR XF tops the bridal car rental segment. It really gives a Pride heads up quotient for the bride and bridegroom arrival.
                Recommended for surprise car rentals and Jaguar bridal cars in Chennai.</p>
        </div>
     </section>
