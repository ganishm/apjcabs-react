    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/bmw_5.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">BMW <span style={{color: "#18B2D3"}}>5 Series</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>BMW 5 Series Car Rental (4+1): </span> <br/>
                4 Door Luxury car for rental in Chennai.
                For few ,BMW is the best car in the world.The pride of travelling in a BMW is sublime giving you supremely quiet ride inspite of any bad roads.
                Five star rating for safety by Euro NCAP.
                It is nothing beyond BMW for its lovers and at APJ cabs we provide well maintained BMW 5 Series for rent. APJ Cabs recommends BMW 5 series for V.I.P Transportation , M.I.P Car rentals and whenever a Luxury car rental is required. AUDI A6 has the most attraction from the youngsters who love to hire it for their wedding reception . We rent AUDI A6 for corporate ,celebrities and bridal car rentals.
               <br/> For hire BMW Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
        </div>
     </section>
