    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/to_inn_cry_z_m.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Toyota <span style={{color: "#18B2D3"}}>Innova Crysta Z</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>INNOVA CRYSTA Z( 6+1): </span> <br/>
                5 Door SUV for rental in Chennai.
                Introduced in 2016 ,it is the new age Toyota Innova.Combination of great exterior features along with Excellent interiors along with good suspension system gives a comfortable ride experience.APJ Cabs highly recommends INNOVA CRYSTA for corporate car rentals,Long distance travel,small group travel, family car rental and wedding car rental.
                <br/>For hire Innova Crysta Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
