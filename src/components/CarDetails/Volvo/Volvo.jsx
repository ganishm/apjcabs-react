    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/vol_bus.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Volvo <span style={{color: "#18B2D3"}}>Bus</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>Volvo Bus Rental in Chennai</span><br/>
                Introduced for long-distance travel, the Volvo Bus is the ultimate choice for large group transportation. It combines sleek exterior design with luxurious interiors, offering a smooth ride experience with its advanced suspension system. APJ Cabs highly recommends the Volvo Bus for corporate group travel, wedding transportation, tourist bus rental, and long-distance group journeys.
               <br/> For Volvo Bus Rental In Chennai, kindly contact us at: Call: (+91) 9677111999 or Mail: cars@apjcabs.com</p>
        </div>
     </section>
