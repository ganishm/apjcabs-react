...
const BenzE = () => {
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/benz_e_cl.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>
            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Mercedes <span style={{color: "#18B2D3"}}> Benz E className</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        ...
        <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>Mercedes Benz E className Rental ( 4+1): </span><br/>
                4 Door Luxury car for rental in Chennai.
                Luxury car rental is incomplete without Mercedes Benz E className Luxury sedan. Mercedes Benz Offers a Sturdy and stylish way of travel solution for all those M.I.P transportation. It is the first choice Luxury car rental vehicle in luxury segment and most popular around the world.
                APJ CABS holds the recent edition of Merc Benz E className well maintained with neat interior and Glossy exterior. Best recommended for Bridal car rentals, celebrity and V.I.P travel.
               <br/> For hire Benz E className Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
        </div>
     </section>
