    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/toy_car_hy.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Toyota <span style={{color: "#18B2D3"}}>Camry Hybrid</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>TOYOTA CAMRY HYBRID (4+1):</span><br/>
                4 Door car for rental in Chennai.
                The Luxury sedans from Toyota is praised for its dependability and spacious interiors. It is preferred for family luxury travel and corporate car rental . Particularly recommended for tall passengers.
                Driven by a powerful V-6 engine the cars shock absorbers are designed to eliminate any harsh road vibrations.
                <br/>For hire Toyoto Camry Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
        </div>
     </section>
