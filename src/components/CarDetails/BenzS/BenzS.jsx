    ...
    return(
        ...
        <div className="container-fluid p-0">
            ...
            <div className="banner-image">
                <img src="/images/carDetails/bens_s_cl.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>
            
            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Mercedes <span style={{color: "#18B2D3"}}>Benz S className</span></h1>
            </div>
        </div>
    </section>
...
<section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>Mercedes Benz S className ( 4+1):</span> <br/>
                4 Door Ultra luxury Car rental in Chennai.
                The top of the line Ultra Luxury flagship model from Mercedes with precise and efficient technology is available for rental in chennai. To satisfy your most important guest or Buyers or V.I.P arrivals Mercedes Benz S className is the best option. The inspiration given can be reaped back only with this lovable luxury car rated as the best German creation to this world.
                APJ CABS provides recent edition Mercedes Benz S className for rental in Chennai an across India.The Multi-lingual Chauffeur’s are well trained with the most modern technologies introduced in the recent Edition.
                <br/>For hire Benz S className Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
        </div>
     </section>
