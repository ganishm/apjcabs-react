    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/audi_q7.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Audi <span style={{color: "#18B2D3"}}>Q7</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>AUDI Q7 Rental In Chennai (4/6*+1) :</span>
                <br/>
                5 door LUXURY SUV rental in Chennai.
                The sleek designed new luxury SUV AUDI Q7 comes with a 3 row option. With its powerful V6 engine with Quattro Technology it is rated and preferred than its competitor Benz GLS or BMW X5.
                With the growing love towards the SUV this vehicle has rapidly picked up in car rental segement.
                Expats and V.I.P prefer to hire AUDI Q7 for the versatile interior , sitting comfort and safety features.
                APJ CABS in Chennai is the only travel agency to rent commercial AUDI Q7 with professional drivers.
                * 3rd Row can accommodate 2 kids. Not comfortable for adults.
                <br/>For hire Audi Q7 Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
        </div>
     </section>
