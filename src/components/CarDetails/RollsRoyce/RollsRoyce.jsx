    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/rr_gh.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Rolls Royce <span style={{color: "#18B2D3"}}>Ghost</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>ROLLS ROYCE Car Rental (3+1): </span><br/>
                4 door Ultra Luxury Car rental in Chennai.
                Rolls Royce for hire in Chennai.
                The KING of cars is a perfect combination of British sophistication and German excellence.
                Rolls Royce is simply anyone dream car and APJ takes pride in renting ROLLS ROYCE for those superlative prestigious People . It brings along the epitome of luxury rolling along with you !
                APJ CABS provides ROLLS ROYCE for rental in Chennai ,Bangalore,Mumbai and Delhi.
                <br/>
                For hire Rolls Royce Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
        </div>
     </section>
