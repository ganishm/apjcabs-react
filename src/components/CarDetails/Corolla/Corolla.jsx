    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/to_co_alt.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Toyota <span style={{color: "#18B2D3"}}>Corolla Altis</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>Toyota Corolla Altis ( 4+1) : </span><br/>
                4 Door car for rental in Chennai.
                The Exclusive sedan car from Toyota Kirloskar.The latest of the corolla which was introduced in 1966 is COROLLA ALTIS . 50+ years in the market shows the people love towards that classic sedan with modern improvements.
                Toyota Corolla Altis is the only car in Chennai among its competitors to have permit for Commercial taxi and car rental usage. Toyota Corolla Altis is such superior such that the top Bureaucrats , Magistrates and many Top notch people of Chennai choose it for their Car rental option. This is the entry level car rental car for Luxury travel.
                Highly recommended for Senior Executive travel and basic Wedding car rentals. We have the recent edition Corolla altis for rental in Chennai and across India.
               <br/> For hire Corolla Altis Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
        </div>
     </section>
