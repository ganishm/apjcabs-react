    ...
    return(
        ...
        <div className="container-fluid p-0">
            <div className="banner-image">
                <img src="/images/carDetails/to_for.png" className="img-fluid" alt="Banner Image"/>
            </div>
            <div className="black-overlay"></div>

            <div className="image-text position-absolute top-50 start-50 translate-middle text-center">
                <h1 className="bus-model-text">Toyota <span style={{color: "#18B2D3"}}>Fortuner</span></h1>
            </div>
        </div>
    </section>
    ...
    <div className="row">
     ...
     <section className="vehicle-overview">
        <div className="vehicle-overview-container text-left">
            ...
            <br/>
            <p style={{marginLeft: "40px", fontSize: "20px"}}><span style={{fontWeight: "bold", color: "black"}}>TOYOTA FORTUNER Car Rental (6+1): </span><br/>
                5 Door SUV for rental in Chennai.
                TOYOTA FORTUNER is a sporty muscular Stylish looking car with great power and performing engine.
                Whatever be the road condition Flooded,bumpy or even off the road FORTUNER would take you to your destination with ease.
                A True SUV big in size gives a powerful look along with Style ,sophistication and comfort.
                APJ CABS recommends TOYOTA FORTUNER for Wedding car rentals , Minister’s car rental, V.I.P Car rental in Chennai and Chennai to Tirupathi Luxury car rentals.
                For hire Toyota Fortuner Car Rental In Chennai Kindly contact @ Call : (+91) 9677111999 or Mail : cars@apjcabs.com</p>
